...
const mockData: LeaveType[] = [
  { id: 1, name: "Annual Leave", createdBy: "Admin", status: "Active" },
  { id: 2, name: "Sick Leave", createdBy: "Admin", status: "Active" },
  { id: 3, name: "Casual Leave", createdBy: "HR Manager", status: "Active" },
  { id: 4, name: "Paternity Leave", createdBy: "Admin", status: "Inactive" },
];
...
export default function LeaveTypeListPage() {
  ...
  const handleExportCSV = () => {
    const csv = [
      ["S.No", "Leave Type Name", "Created By", "Status"],
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        ...
        <Link href="/dashboard/master/leave-types/add">
          <Button>
      ...
      <Dialog open={editDialog} onOpenChange={setEditDialog}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>Update the leave type name</DialogDescription>
          </DialogHeader>
