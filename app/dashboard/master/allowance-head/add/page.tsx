...
export default function AddAllowanceHeadPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    startTransition(async () => {
      ...
      if (result.status) {
        toast.success(result.message || "Allowance heads created successfully");
        router.push("/dashboard/master/allowance-head/list");
      } else {
  ...
  return (
    <div className="max-w-6xl mx-auto">
      <div className="mb-6">
        <Link href="/dashboard/master/allowance-head/list">
