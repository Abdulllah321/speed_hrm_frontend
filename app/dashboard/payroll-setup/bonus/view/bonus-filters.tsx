        ...
        <CardHeader className="pb-4">
          <div className="flex items-center justify-between">
            <div>
              ...
              <CardDescription>
                Filter bonus records by department, employee, type, or status
              </CardDescription>
            </div>
        ...
        <CollapsibleContent>
          <CardContent className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
              ...
              {/* Bonus Type Filter */}
              <div className="space-y-2">
                <Label htmlFor="bonus-type-filter">Bonus Type</Label>
                {loading ? (
                  <div className="h-10 bg-muted rounded-md animate-pulse" />
                ) : (
                  <Autocomplete
                    ...
                    value={filters.bonusTypeId}
                    onValueChange={(value) =>
                      handleFilterChange("bonusTypeId", value || "all")
                    }
