...
export default function ErpNetSalesSummaryReportPage() {
    ...
    // Format locations for MultiSelect
    ...
    // Fetch cashiers for selected locations
    useEffect(() => {
        async function fetchCashiers() {
            try {
                const res = await getSalespersons(locationParam);
    ...
    }, [locationParam, dateRange, cashierUserId, groupingLevels, summaryOnly]);

    useEffect(() => {
        fetchReport();
    }, [locationParam, groupingLevels, cashierUserId, dateRange]);
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-border pb-5 no-print">
                <div>
                    ...
                    <p className="text-sm text-muted-foreground mt-1 flex items-center gap-1.5 font-medium">
                        ...
                        ERP Net Sales & Tax Summary for: <span className="text-foreground font-semibold">{activeSelectionNames}</span>
                    </p>
                </div>
                    ...
                    <Button
                        ...
                        className={cn(
                            ...
                            pdfExportState === "completed"
                                ...
                                : "border-red-500/40 text-red-700 hover:bg-red-50 dark:text-red-400 dark:hover:bg-red-955/30"
                        )}
                    >
                    ...
                    <Button
                        ...
                        className={cn(
                            ...
                            exportState === "completed"
                                ...
                                : "border-emerald-500/40 text-emerald-700 hover:bg-emerald-50 dark:text-emerald-400 dark:hover:bg-emerald-955/30"
                        )}
                    >
                ...
                <div className="flex flex-wrap items-end gap-4">
                    ...
                    <div className="flex flex-col gap-1.5 min-w-[200px]">
                        ...
                        <select
                            ...
                            className="bg-background border rounded-lg h-10 px-3 text-xs font-semibold focus:ring-primary focus:border-primary cursor-pointer outline-none w-full"
                        >
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-4 gap-4 no-print">
                <Card className="shadow-xs border-slate-100">
                    <CardContent className="p-4 flex items-center justify-between">
                        ...
                        <div className="rounded-lg p-2 bg-blue-50 dark:bg-blue-955/20 text-blue-600 dark:text-blue-400">
                ...
                <Card className="shadow-xs border-slate-100">
                    <CardContent className="p-4 flex items-center justify-between">
                        ...
                        <div className="rounded-lg p-2 bg-emerald-50 dark:bg-emerald-955/20 text-emerald-600">
                                ...
                                {paddingTop > 0 && (
                                 ...
                                 {virtualItems.map((virtualRow) => {
                                    ...
                                    const LEVEL_UI_STYLES: Record<string, { className: string; indentClass: string }> = {
                                        ...
                                        variant: { className: "hover:bg-slate-50 dark:hover:bg-slate-900/35 text-slate-655 dark:text-slate-400 bg-background transition-colors h-[36px]", indentClass: "pl-48" },
                                    };
