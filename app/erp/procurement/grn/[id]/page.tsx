...
export default function GrnDetailPage() {
  ...
  if (!grn)
    return <div className="p-6 text-center text-red-500">GRN not found</div>;

  const totalReceivedQty = grn.items.reduce(
    (sum, item) => sum + parseFloat((item.receivedQty as any) || "0"),
    0,
  );
                  ...
                  <div className="flex flex-col md:items-center">
                    ...
                    {grn.checkedById ? (
                      <>
                        ...
                        <span className="text-[10px] text-slate-500 mt-0.5">
                          {grn.checkedAt
                            ? new Date(grn.checkedAt).toLocaleDateString()
                            : ""}
                        </span>
                      </>
                    ) : grn.status === "PENDING_CHECKER" ? (
                  ...
                  <div className="flex flex-col md:items-center">
                    ...
                    {grn.authorizedById ? (
                      <>
                        ...
                        <span className="text-[10px] text-slate-500 mt-0.5">
                          {grn.authorizedAt
                            ? new Date(grn.authorizedAt).toLocaleDateString()
                            : ""}
                        </span>
                      </>
                    ) : grn.status === "PENDING_AUTHORIZER" ? (
  ...
  switch (status) {
    case "PENDING_CHECKER":
      return (
        <Badge
          variant="outline"
          className="bg-amber-50 text-amber-700 border-amber-200 font-medium dark:bg-amber-950/30 dark:text-amber-400 dark:border-amber-900 text-[13px] px-2.5 py-0.5"
        >
          Pending Checker
        </Badge>
      );
    case "PENDING_AUTHORIZER":
      return (
        <Badge
          variant="outline"
          className="bg-blue-50 text-blue-700 border-blue-200 font-medium dark:bg-blue-950/30 dark:text-blue-400 dark:border-blue-900 text-[13px] px-2.5 py-0.5"
        >
          Pending Authorizer
        </Badge>
      );
    case "VALUED":
      return (
        <Badge
          variant="outline"
          className="bg-emerald-50 text-emerald-700 border-emerald-200 font-medium dark:bg-emerald-950/30 dark:text-emerald-400 dark:border-emerald-900 text-[13px] px-2.5 py-0.5"
        >
          Valued
        </Badge>
      );
    ...
    case "REJECTED":
      return (
        <Badge
          variant="outline"
          className="bg-rose-50 text-rose-700 border-rose-200 font-medium dark:bg-rose-950/30 dark:text-rose-400 dark:border-rose-900 text-[13px] px-2.5 py-0.5"
        >
          Rejected
        </Badge>
      );
    default:
      return (
        <Badge
          variant="outline"
          className="bg-slate-50 text-slate-700 border-slate-200 font-medium dark:bg-slate-950/30 dark:text-slate-400 dark:border-slate-900 text-[13px] px-2.5 py-0.5"
        >
          {status}
        </Badge>
      );
