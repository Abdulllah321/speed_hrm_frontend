...
export default function DebitNoteDetailPage() {
  ...
  if (loading)
    return <div className="p-6 text-center">Loading debit note...</div>;
          ...
          <div className="bg-white p-8 border rounded-lg shadow-sm">
            ...
            <div className="flex justify-between items-start border-b pb-6 mb-6">
              ...
              <div className="text-right">
                <h2 className="text-xl font-bold">Speed (pvt.) Limited</h2>
              ...
              <div>
                ...
                <div className="space-y-1">
                  ...
                  <p className="text-gray-600">
                    {note.supplier?.address || "Pakistan"}
                  </p>
                </div>
              </div>
              <div className="text-right">
                ...
                <div className="space-y-1">
                  ...
                  {note.purchaseReturn && (
                    <p>
                      <span className="text-gray-500">Against Return:</span>{" "}
                      {note.purchaseReturn.returnNumber}
                    </p>
                  )}
                  {note.purchaseReturn?.staxEInvoiceNumber && (
                    <p>
                      <span className="text-gray-500">STax e-Inv #:</span>{" "}
                      {note.purchaseReturn.staxEInvoiceNumber}
                    </p>
                  )}
                  {(() => {
            ...
            <div className="bg-gray-50 p-6 rounded-lg border mb-8">
              ...
              <p className="text-sm text-gray-500 mt-2 italic">
                Note: This amount has been debited to your account against the
                goods returned.
              </p>
            </div>
            ...
            {/* Breakdown */}
            {note.purchaseReturn?.items &&
              note.purchaseReturn.items.length > 0 && (
                <div className="mt-8">
            ...
            <div className="mt-16 flex justify-between border-t pt-8">
              <div className="text-center w-40">
                <div className="border-t border-dashed pt-2 text-xs text-gray-500">
                  Prepared By
                </div>
              </div>
              <div className="text-center w-40">
            ...
            <div className="flex gap-4 mb-4 text-xs sm:text-[13px]">
              <div className="w-1/2 p-2 border border-gray-300 flex flex-col justify-center">
                ...
                <div className="flex gap-2 mb-1">
                  ...
                  <span>{note.supplier?.name || "N/A"}</span>
                </div>
                <div className="flex gap-2 mb-1">
                  <span className="font-bold w-16 shrink-0">Code:</span>{" "}
                  <span>{note.supplier?.code || "N/A"}</span>
                </div>
              </div>
              <div className="w-1/2 p-2 border border-gray-300 flex flex-col justify-center">
                <div className="font-bold border-b border-gray-300 mb-2 pb-1">
                ...
                <div className="flex gap-2 mb-1">
                  <span className="font-bold w-16 shrink-0">Name:</span>{" "}
                  <span>{note.purchaseReturn?.warehouse?.name || "N/A"}</span>
                </div>
              </div>
            </div>
            ...
            <table className="w-full text-[10px] sm:text-[11px] mb-4 border-collapse">
              <thead>
                <tr className="border-y-2 border-black">
                  ...
                  <th className="py-1 pr-1 text-left font-bold w-[8%]">
                    HS Code
                  </th>
                  <th className="py-1 pr-1 text-left font-bold w-[21%]">
                    Description
                  </th>
                  ...
                  <th className="py-1 pr-1 text-right font-bold w-[11%]">
                    Val Excl Tax
                  </th>
                  ...
                  <th className="py-1 text-right font-bold w-[10%]">
                    Line Total
                  </th>
                </tr>
              </thead>
                ...
                note.purchaseReturn.items.length > 0 ? (
                  note.purchaseReturn.items.map((item: any, i: number) => {
                    const advRate = Number(
                      note.purchaseInvoice?.advanceTaxRate ||
                        note.purchaseReturn?.purchaseInvoice?.advanceTaxRate ||
                        0.5,
                    );
              ...
              <div className="w-[50%] pt-4 flex flex-col justify-end">
                <div className="flex gap-2 font-bold mb-1">
                  ...
                  <span className="underline decoration-1 underline-offset-2 break-words">
                    {numberToWords(Number(note.amount || 0))}
                  </span>
                </div>
              </div>
