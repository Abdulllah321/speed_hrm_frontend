...
export function EOBIReportList({ initialData }: EOBIReportListProps) {
    const [data] = useState<EOBIReportItem[]>(initialData);
    ...
    `;
      ...
      <html>
        <head>
          <title>Employee EOBI Report</title>
          <style>
        ...
        <body>
          ...
          <div class="subtitle">EOBI balances and withdrawals</div>
          <div class="meta">
          ...
          <table>
            <thead>
              <tr>
                ...
                <th>Designation</th>
                <th>Total EOBI</th>
                <th>EOBI Withdrawal</th>
                <th>EOBI Closing Amount</th>
              </tr>
            </thead>
            <tbody>
              ${tableRows}
    ...
    const handleExportCSV = () => {
        ...
        a.href = url;
        a.download = `eobi_report_${new Date().toISOString().split('T')[0]}.csv`;
        a.click();
    ...
    return (
        <div className="space-y-6">
            <div className="flex items-center justify-between no-print">
                <div>
                    <h2 className="text-2xl font-bold tracking-tight">View Employee EOBI Report</h2>
                    <p className="text-muted-foreground">
                        Detailed report of EOBI balances and withdrawals
                    </p>
                </div>
            ...
            <Card>
                <CardHeader>
                    <CardTitle>Employee EOBI Report</CardTitle>
                </CardHeader>
                <CardContent>
