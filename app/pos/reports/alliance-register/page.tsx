...
export default function AllianceRegisterReportPage() {
    const { user } = useAuth();
    ...
    return (
        <div className="space-y-6 p-1 sm:p-6 max-w-[1600px] mx-auto">
                ...
                <div className="space-y-1">
                    <div className="flex items-center gap-2">
                        ...
                        <h1 className="text-2xl font-black tracking-tight text-slate-900 dark:text-white">
                            Alliance Register Report
                        </h1>
                    </div>
                    <p className="text-sm text-muted-foreground font-medium">
                        Detailed listing of alliance sales and manual discounts applied in conjunction with alliance programs.
                    </p>
                </div>
            ...
            <div className="hidden print:block border-b-2 border-slate-900 pb-3 mb-4">
                ...
                <h3 className="text-md font-semibold text-slate-700">Alliance Register Report</h3>
            ...
            <div className="flex flex-wrap items-center justify-between gap-4 bg-slate-50 dark:bg-slate-900/40 border p-4 rounded-xl shadow-sm no-print">
                ...
                <div className="flex items-center gap-1.5 text-xs text-muted-foreground font-semibold">
                    ...
                    <span>{COMPANY_NAME} &bull; Alliance Sales</span>
                </div>
            </div>
                ...
                <Card className="shadow-xs border-slate-100">
                    <CardContent className="p-4 flex items-center justify-between">
                        <div>
                            ...
                            <h3 className="text-xl font-bold mt-1 text-rose-600 dark:text-rose-455">{formatVal(grandTotals.discount)}</h3>
                        </div>
