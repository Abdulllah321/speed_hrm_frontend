...
export default function InboundRequestsPage() {
    ...
    const handlePrint = (request: any) => {
        ...
        const sourceLoc = request.fromLocation?.name || request.fromWarehouse?.name || "Source Warehouse/Outlet";
        const destLoc = user?.terminal?.location?.name || "This Location";
        const refNo = request.requestNo || "N/A";
        const inboundNo = request.inboundNo || request.formattedSerialNo || null;
        ...
        win.document.write(`
            ...
            <html>
            <head>
                <title>Inbound Stock Transfer - ${refNo}</title>
                <style>
            ...
            <body>
                <div class="header">
                    ...
                    <div class="title-box">
                        <div class="title-main">Stock Transfer IN</div>
                    ...
                    <div class="meta-box">
                        ...
                        ${inboundNo ? `
                        <div class="meta-row">
                            <span class="meta-label">Inbound Serial No:</span>
                            <span class="meta-val">${inboundNo}</span>
                        </div>` : ''}
                        <div class="meta-row">
                                        ...
                                        <div className="bg-green-50 p-4 md:w-48 flex flex-col justify-between border-b md:border-b-0 md:border-r border-green-200">
                                            <div className="space-y-1">
                                                ...
                                                {(request.inboundNo || request.formattedSerialNo) && (
                                                    <Badge variant="outline" className="text-[10px] bg-green-100/50 text-green-900 border-green-300 font-mono">
                                                ...
                                                <div className="flex flex-wrap items-center gap-6">
                                                    ...
                                                    <div className="h-10 w-px bg-border hidden sm:block" />
                                                     <div className="flex flex-col">
                                                         ...
                                                         <span className="text-sm font-semibold">{request.fromLocation?.name || request.fromWarehouse?.name || "Source Warehouse/Outlet"}</span>
                                                     </div>
                                                    <div className="h-10 w-px bg-border hidden sm:block" />
                                                    <div className="flex flex-col">
