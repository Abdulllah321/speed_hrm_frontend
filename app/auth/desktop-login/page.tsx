...
export default function DesktopLoginPage() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (bridge) {
        ...
        if (!reg.status)
          console.warn("[DesktopLogin] Device registration:", reg.message);
      }
  ...
  const renderRegistering = () => (
    <div className="flex flex-col items-center justify-center py-14 gap-5 animate-in fade-in duration-300">
      ...
      <div className="text-center space-y-1">
        ...
        <p className="text-sm text-muted-foreground">
          Securing your session with the cloud...
        </p>
      </div>
  ...
  const renderLogin = () => (
    ...
    >
        ...
        {isOnline ? (
          ...
          <>
            ...
            <span className="text-[11px] text-amber-600 font-semibold">
              Offline — login required when connected
            </span>
          </>
        )}
      </div>
      ...
      {loginError && (
        <Alert
          variant="destructive"
          className="animate-in slide-in-from-top-2 border-destructive/50 bg-destructive/10"
        >
  ...
  const renderLocationList = () => (
    <div className="space-y-4 animate-in fade-in slide-in-from-right-4 duration-300">
      <div className="text-center space-y-2 mb-4">
        ...
        <p className="text-sm text-muted-foreground">
          Choose a location to set up the POS terminal.
        </p>
      </div>
      <div className="space-y-2">
      ...
      <Button
        ...
        onClick={() => setPosStep("location-code")}
      >
  ...
  const renderLocationCode = () => (
    <div className="space-y-4 animate-in fade-in slide-in-from-right-4 duration-300">
      <div className="text-center space-y-2 mb-6">
        ...
        <p className="text-sm text-muted-foreground">
          Enter the code assigned to your store location.
        </p>
      </div>
      <div className="space-y-2">
  ...
  const renderPin = () => (
    <div className="space-y-6 animate-in fade-in slide-in-from-right-4 duration-300">
          ...
          {[...Array(4)].map((_, i) => (
            <div
              ...
              className={cn(
                ...
                pin.length > i
                  ? "bg-primary scale-110 shadow-[0_0_10px_var(--color-primary)]"
      ...
      <div className="grid grid-cols-3 gap-3 max-w-[280px] mx-auto">
        ...
        <Button
          variant="ghost"
          className="h-14 text-sm font-medium hover:bg-destructive/10 hover:text-destructive"
          onClick={() => setPin("")}
        >
          CLEAR
        </Button>
      ...
      <div className="space-y-3">
        ...
        <div className="flex items-center space-x-2 justify-center py-1">
          <Checkbox
            ...
            onCheckedChange={(c) => setRememberTerminal(!!c)}
          />
          <Label
            htmlFor="remember"
  ...
  const titles: Record<string, string> = {
    checking: "Speed (pvt.) Limited POS",
        ...
        <Card className="shadow-2xl backdrop-blur-sm bg-card/95">
          ...
          <CardContent className="pt-2 min-h-[320px] flex flex-col justify-center">
            ...
            {phase === "pos-setup" && posError && (
              <Alert
                variant="destructive"
                className="mb-4 animate-in slide-in-from-top-2 border-destructive/50 bg-destructive/10"
              >
                <AlertCircle className="h-4 w-4" />
            ...
            {phase === "pos-setup" &&
              posStep === "location-list" &&
              renderLocationList()}
            {phase === "pos-setup" &&
              posStep === "location-code" &&
              renderLocationCode()}
            {phase === "pos-setup" &&
              posStep === "terminal-select" &&
