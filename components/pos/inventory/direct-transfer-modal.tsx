...
import { Package, Send, AlertCircle, CheckCircle2, Printer, Loader2 } from "lucide-react";
            ...
            <DialogContent className="sm:max-w-[425px]">
                {isSuccess ? (
                    <div className="py-6 flex flex-col items-center justify-center text-center">
                        ...
                        <h3 className="text-xl font-bold text-foreground font-sans">Transfer Sent Out!</h3>
                    ...
                    <>
                        <DialogHeader>
                            <div className="flex items-center gap-2 mb-1">
                                ...
                                <DialogTitle className="text-xl font-bold tracking-tight">Direct Transfer Out</DialogTitle>
                            </div>
