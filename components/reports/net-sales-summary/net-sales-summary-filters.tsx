          ...
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <p className="font-bold text-slate-900 dark:text-slate-100 flex items-center gap-1.5">
                Net Sales Formula Equation
              </p>
              <p className="text-[11px] font-mono text-slate-600 dark:text-slate-300 mt-0.5">
                <span className="font-bold text-emerald-600 dark:text-emerald-400">Net Sales</span> = Gross Sales - Return Amount - Discounts + Taxes &bull; <span className="font-bold text-sky-600 dark:text-sky-400">Net Qty</span> = Sold Qty - Return Qty
              </p>
            </div>
          </div>
          <button
          ...
          <div className="flex items-center gap-2.5">
            ...
            <div className="space-y-0.5">
              <p className="font-bold flex items-center gap-2">
                Generating Net Sales Category Summary Matrix
              ...
              <p className="text-[11px] text-slate-600 dark:text-slate-300">
                {sseState.message || "Auditing checkout sales & return ledgers to compute net revenue..."}
              </p>
            </div>
          </div>
        </div>
