          ...
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <p className="font-bold text-slate-900 dark:text-slate-100 flex items-center gap-1.5">
                Net Sales Summary Core Equation
              </p>
              <p className="text-[11px] font-mono text-slate-600 dark:text-slate-300 mt-0.5">
                <span className="font-bold text-emerald-600 dark:text-emerald-400">Net Sales Revenue</span> = Gross Checkout Total - Returns/Refunds - Item Discounts + Taxes &bull; Real-time Multi-Outlet Store Matrix
              </p>
            </div>
          </div>
          <button
