...
import { WholesaleInvoiceTotals } from "./types";
...
interface WholesaleInvoiceHeaderProps {
  totals: WholesaleInvoiceTotals;
}

export function WholesaleInvoiceHeader({ totals }: WholesaleInvoiceHeaderProps) {
            ...
            <div className="flex items-center gap-1">
              ...
              <Tooltip>
                ...
                <TooltipContent side="top" className="max-w-xs text-[11px] font-medium bg-slate-900 text-slate-100">
                  Total revenue including all taxes and discounts.
                </TooltipContent>
              </Tooltip>
            </div>
          ...
          <div>
            <div className="flex items-center gap-1">
              ...
              <Tooltip>
                ...
                <TooltipContent side="top" className="max-w-xs text-[11px] font-medium bg-slate-900 text-slate-100">
                  Total physical product quantity across all invoices.
                </TooltipContent>
              </Tooltip>
            </div>
          ...
          <div>
            <div className="flex items-center gap-1">
              ...
              <Tooltip>
                ...
                <TooltipContent side="top" className="max-w-xs text-[11px] font-medium bg-slate-900 text-slate-100">
                  Sales tax collected on invoices.
                </TooltipContent>
              </Tooltip>
            </div>
            <p className="text-lg font-bold text-slate-900 dark:text-slate-100 mt-1 font-mono">
