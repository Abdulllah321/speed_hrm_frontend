...
import { SalesRegisterInvoiceNode, SalesRegisterFlatRecord, SalesRegisterTotals } from "./types";

const yieldToMain = () => new Promise((resolve) => setTimeout(resolve, 0));

export async function generateSalesRegisterExcel(opts: {
  ...
  const fileName = `sales-register-report-${dateStr}-${exportType}.xlsx`;
  ...
  if (exportType === "flat") {
    ...
    XLSX.utils.book_append_sheet(workbook, worksheet, "Sales Register Matrix");
  }
