...
interface SalesRegisterFiltersProps {
  isPosLevel?: boolean;
...
export function SalesRegisterFilters({
  isPosLevel = false,
  ...
  return (
    <div className="space-y-3 mb-4 no-print">
      {/* Information Container Card: Sales Register Guidance */}
      {showFormulaInfo && (
          ...
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <p className="font-bold text-slate-900 dark:text-slate-100 flex items-center gap-1.5">
                Sales Register Invoice Matrix
              </p>
              <p className="text-[11px] font-mono text-slate-600 dark:text-slate-300 mt-0.5">
                <span className="font-bold text-emerald-600 dark:text-emerald-400">Total Net Sales</span> = Sum of Invoice Grand Totals &bull; Real-time POS Transaction Register
              </p>
            </div>
          </div>
          <button
      ...
      <div className="flex flex-wrap items-center justify-between gap-3 p-3.5 rounded-2xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 shadow-sm">
        ...
        <div className="flex flex-wrap items-center gap-2">
            ...
            <PopoverContent side="bottom" align="end" className="w-64 p-3.5 space-y-3 rounded-2xl shadow-xl">
              ...
              <div className="space-y-2.5 text-xs">
                ...
                <div className="flex items-center gap-2">
                  <Checkbox
                    id="lvl-inv"
                    checked={groupingLevels.invoice}
                    onCheckedChange={(c) => onToggleLevel("invoice", !!c)}
                  />
                  <Label htmlFor="lvl-inv">Sales Register Invoice Number</Label>
                </div>
                <div className="flex items-center gap-2">
                  <Checkbox
                    id="lvl-item"
                  ...
                  />
                  <Label htmlFor="lvl-item">Line Items (Category / Brand / Barcode)</Label>
                </div>
              </div>
            </PopoverContent>
          </Popover>
          ...
          {/* Export Excel (Flat & Hierarchical) */}
          <Popover>
            <PopoverTrigger asChild>
              <Button
                variant="outline"
            ...
            <PopoverContent align="end" className="w-52 p-2 space-y-1 rounded-2xl shadow-xl text-xs">
              ...
              <button
                ...
                className="w-full text-left px-3 py-2 rounded-xl hover:bg-slate-100 dark:hover:bg-slate-800 font-medium transition-colors"
              >
                Export Register Invoices (Matrix)
              </button>
            </PopoverContent>
          </Popover>
          ...
          <div className="flex items-center gap-2.5">
            ...
            <div className="space-y-0.5">
              <p className="font-bold flex items-center gap-2">
                Generating Sales Register Calculation Matrix
              ...
              <p className="text-[11px] text-slate-600 dark:text-slate-300">
                {sseState.message || "Querying POS sales register invoices & compiling category totals..."}
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="flex items-center gap-2.5 flex-1 max-w-md">
          <div className="relative w-full">
            ...
            <Input
              ...
              placeholder="Search invoice #, customer name, phone, cashier, or category/brand/SKU..."
