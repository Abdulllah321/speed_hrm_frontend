...
interface WholesaleReturnFiltersProps {
...
export function WholesaleReturnFilters({
  reportType,
  onReportTypeChange,
  dateRange,
  onDateRangeChange,
          ...
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <p className="font-bold text-slate-900 dark:text-slate-100 flex items-center gap-1.5">
                Wholesale Return Formula Equation
              </p>
          ...
          <div className="flex items-center gap-2.5">
            ...
            <div className="space-y-0.5">
              <p className="font-bold flex items-center gap-2">
                Generating Wholesale Return Matrix
              ...
              <p className="text-[11px] text-slate-600 dark:text-slate-300">
                {sseState.message || "Querying wholesale Returns & computing totals..."}
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="flex items-center gap-2.5 flex-1 max-w-md">
          <div className="relative w-full">
            ...
            <Input
              ...
              placeholder="Search category, brand, SKU, Return No, or description..."
