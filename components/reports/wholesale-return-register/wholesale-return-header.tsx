...
import { WholesaleReturnTotals } from "./types";
...
interface WholesaleReturnHeaderProps {
  totals: WholesaleReturnTotals;
}

export function WholesaleReturnHeader({ totals }: WholesaleReturnHeaderProps) {
          ...
          <div>
            <div className="flex items-center gap-1">
              ...
              <Tooltip>
                ...
                <TooltipContent side="top" className="max-w-xs text-[11px] font-medium bg-slate-900 text-slate-100">
                  Total physical product quantity across all Returns.
                </TooltipContent>
              </Tooltip>
            </div>
          ...
          <div>
            <div className="flex items-center gap-1">
              ...
              <Tooltip>
                ...
                <TooltipContent side="top" className="max-w-xs text-[11px] font-medium bg-slate-900 text-slate-100">
                  Sales tax collected on Returns.
                </TooltipContent>
              </Tooltip>
            </div>
            <p className="text-lg font-bold text-slate-900 dark:text-slate-100 mt-1 font-mono">
