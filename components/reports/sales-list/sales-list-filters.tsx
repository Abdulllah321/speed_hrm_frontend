...
export function SalesListFilters({
  ...
  return (
    <div className="space-y-3 mb-4 no-print">
      {/* Information Container Card: Sales List Guidance */}
      {showFormulaInfo && (
          ...
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <p className="font-bold text-slate-900 dark:text-slate-100 flex items-center gap-1.5">
                Sales Transaction Register Equation
              </p>
              <p className="text-[11px] font-mono text-slate-600 dark:text-slate-300 mt-0.5">
                <span className="font-bold text-emerald-600 dark:text-emerald-400">Total Net Revenue</span> = &sum; Order Grand Total &bull; <span className="font-bold text-sky-600 dark:text-sky-400">Tender Breakdown</span> = Cash + Card + Voucher
              </p>
            </div>
          </div>
          <button
            ...
            <PopoverContent side="bottom" align="end" className="w-64 p-3.5 space-y-3 rounded-2xl shadow-xl">
              ...
              <div className="space-y-2.5 text-xs">
                ...
                <div className="flex items-center gap-2">
                  ...
                  />
                  <Label htmlFor="lvl-inv">Sales Invoice Number</Label>
                </div>
                <div className="flex items-center gap-2">
                  <Checkbox
                    id="lvl-item"
                  ...
                  />
                  <Label htmlFor="lvl-item">Line Items (Barcode / SKU)</Label>
                </div>
              </div>
            </PopoverContent>
          </Popover>
          ...
          <div className="flex items-center gap-2.5">
            ...
            <div className="space-y-0.5">
              <p className="font-bold flex items-center gap-2">
                Generating Sales List Calculation Matrix
              ...
              <p className="text-[11px] text-slate-600 dark:text-slate-300">
                {sseState.message || "Querying POS sales invoices & compiling payment totals..."}
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="flex items-center gap-2.5 flex-1 max-w-md">
          <div className="relative w-full">
            ...
            <Input
              ...
              placeholder="Search invoice #, customer name, phone, cashier, or SKU..."
