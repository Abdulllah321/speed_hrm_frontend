...
import { Layers, ArrowDownLeft, ArrowUpRight, ShoppingCart, PackageCheck, Truck, Info, CornerUpLeft, Building2 } from "lucide-react";
...
export function StockActivityHeader({ totals, reportType = "merged" }: StockActivityHeaderProps) {
  const formatVal = (val?: number | null) => (val == null || val === 0) ? "-" : val.toLocaleString();
  ...
  if (reportType === "detailed") {
    return (
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-3.5 no-print">
              ...
              <div className="flex items-center gap-1.5">
                ...
                <Tooltip>
                  ...
                  <TooltipContent side="top" className="max-w-xs text-[11px] font-medium bg-slate-900 text-slate-100">
                    Total starting warehouse stock brought forward before the selected start date.
                  </TooltipContent>
                </Tooltip>
              </div>
            ...
            <div>
              <div className="flex items-center gap-1.5">
                ...
                <Tooltip>
                  ...
                  <TooltipContent side="top" className="max-w-xs text-[11px] font-medium bg-slate-900 text-slate-100">
                    Total vendor purchases received into warehouse via GRN and Landed Cost.
                  </TooltipContent>
                </Tooltip>
              </div>
            ...
            <div>
              <div className="flex items-center gap-1.5">
                ...
                <Tooltip>
                  ...
                  <TooltipContent side="top" className="max-w-xs text-[11px] font-medium bg-slate-900 text-slate-100">
                    Total stock returned to vendors/suppliers during the selected period.
                  </TooltipContent>
                </Tooltip>
              </div>
        ...
        {/* To Outlets (Transfers Dispatched) */}
        <Card className="shadow-2xs border-slate-200/80 dark:border-slate-800/80 bg-white dark:bg-slate-900/80 backdrop-blur-xs rounded-2xl overflow-hidden relative group hover:border-indigo-500/40 transition-all">
          <CardContent className="p-4 flex items-center justify-between">
            <div>
              <div className="flex items-center gap-1.5">
                ...
                <Tooltip>
                  ...
                  <TooltipContent side="top" className="max-w-xs text-[11px] font-medium bg-slate-900 text-slate-100">
                    Total stock dispatched from warehouse to retail outlets/stores.
                  </TooltipContent>
                </Tooltip>
              </div>
            ...
            <div>
              <div className="flex items-center gap-1.5">
                ...
                <Tooltip>
                  ...
                  <TooltipContent side="top" className="max-w-xs text-[11px] font-medium bg-slate-900 text-slate-100">
                    Stock dispatched for wholesale orders via Delivery Challan.
                  </TooltipContent>
                </Tooltip>
              </div>
            ...
            <div>
              <div className="flex items-center gap-1.5">
                ...
                <Tooltip>
                  ...
                  <TooltipContent side="top" className="max-w-xs text-[11px] font-medium bg-slate-900 text-slate-100">
                    Current physically available stock on hand in warehouse (Opening + Purchases - Purchase Ret + From Outlets - To Outlets - DC + Ret + Adj).
                  </TooltipContent>
                </Tooltip>
              </div>
